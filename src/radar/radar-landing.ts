...
@Component({
    ...
    templateUrl: '/radar/radar-landing.html',
    //  styleUrls: [ '/radar/components/select-area/select-area.component.css'],
    //  directives: [ItemFormComponent],
    directives: [ItemFormComponent, EmbracementComponent, SelectAreaComponent]
})


export class RadarLandingComponent implements OnInit {
    ...
    constructor(private _heroService: ManageService, private _radarService: RadarService,
        ...
        console.log('drze', 'has landed');
    }

    areaSelected(event) {
        console.log('Area selected in landing page', event);
    }
    ...
    openCategory(areaStr: string) {
        this._router.navigate(['ItemsInCategoryDetail', { category: areaStr }]);
    }
